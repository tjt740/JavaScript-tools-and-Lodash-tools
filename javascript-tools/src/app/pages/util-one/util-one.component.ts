...
export class UtilOneComponent implements OnInit {
  ...
  ngOnInit(): void {
    console.log(this.monacoDom.nativeElement);
    this.monacoInstance = monaco.editor.create(this.monacoDom.nativeElement, {
      value: `console.log("hello,world")`, // 初始化value
      language: 'javascript', // 语言模型
